...
<head>
    ...
    <title>MoF - Mansion of Fire - League</title>

    <link rel="canonical" href="https://mof-league.com/" />
...
<body>
    <header class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
        <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3" href="#">Mansion of Fire</a>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4" ng-app="mfoApp">
                <ng-view></ng-view>
            </main>
        </div>
    </div>
